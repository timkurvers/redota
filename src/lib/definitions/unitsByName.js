...
export default augment({
  ...
  npc_dota_broodmother_spiderling: {
    ...
    variants: [
      ...
      'models/items/broodmother/spiderling/ardalan_ambusher_spiderling/ardalan_ambusher_spiderling.vmdl',
      'models/items/broodmother/spiderling/bride_of_the_web_spiderling/bride_of_the_web_spiderling.vmdl',
      'models/items/broodmother/spiderling/broodmother_sunless_abyss_spiderling/broodmother_sunless_abyss_spiderling.vmdl',
      ...
      'models/items/broodmother/spiderling/helpers_assistants/helpers_assistants.vmdl',
      'models/items/broodmother/spiderling/lycosidae_spiderling/lycosidae_spiderling.vmdl',
      'models/items/broodmother/spiderling/nightmare_spiderlings/nightmare_spiderlings.vmdl',
      ...
      'models/items/broodmother/spiderling/pinemothers_pineling/pinemothers_pineling.vmdl',
  ...
  npc_dota_eidolon: {
    ...
    variants: [
      ...
      'models/items/enigma/eidolon/gluttonys_vanguard/gluttonys_vanguard.vmdl',
  ...
  npc_dota_furion_treant: {
    ...
    variants: [
      ...
      'models/items/furion/treant/jadevine_ascendant_treant/jadevine_ascendant_treant.vmdl',
      ...
      'models/items/furion/treant/np_verdant_swarm_ability/np_verdant_swarm_ability.vmdl',
      ...
      'models/items/furion/treant/soul_tree_ability/soul_tree_ability.vmdl',
  ...
  npc_dota_juggernaut_healing_ward: {
    ...
    variants: [
      ...
      'models/items/juggernaut/ward/headhunters_legacy_magpies_nest/headhunters_legacy_magpies_nest.vmdl',
      'models/items/juggernaut/ward/healing_gills_of_the_lost_isles/healing_gills_of_the_lost_isles.vmdl',
      'models/items/juggernaut/ward/juggernaut_primal_ability/juggernaut_primal_ability.vmdl',
      ...
      'models/items/juggernaut/ward/vestments_of_the_yurneros_path_ward/vestments_of_the_yurneros_path_ward.vmdl',
    ],
  },
  ...
  npc_dota_lycan_wolf: {
    ...
    variants: [
      ...
      'models/items/lycan/wolves/scavenger_hyena/scavenger_hyena.vmdl',
  ...
  npc_dota_phoenix_sun: {
    ...
    variants: [
      ...
      'models/items/phoenix/ultimate/captive_star_supernova/captive_star_supernova.vmdl',
      'models/items/phoenix/ultimate/dark_owl_owlet/dark_owl_owlet.vmdl',
      ...
      'models/items/phoenix/ultimate/ignis_machina_supernova/ignis_machina_supernova.vmdl',
      ...
      'models/items/phoenix/ultimate/phoenix_lunar_new_year_supernova/phoenix_lunar_new_year_supernova.vmdl',
  ...
  npc_dota_pugna_nether_ward: {
    ...
    variants: [
      ...
      'models/items/pugna/ward/elderbark_sorcerers_nether_ward/elderbark_sorcerers_nether_ward.vmdl',
  ...
  npc_dota_techies_remote_mine: {
    ...
    variants: [
      ...
      'models/items/techies/pirate_of_treasures_mines/pirate_of_treasures_mines.vmdl',
      'models/items/techies/techies_mad_tex_arms/techies_mad_tex_arms.vmdl',
  ...
  npc_dota_wraith_king_skeleton_warrior: {
    ...
    variants: [
      ...
      'models/items/wraith_king/frostivus_wraith_king/frostivus_wraith_king_skeleton.vmdl',
