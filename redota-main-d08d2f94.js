...
`,s=e=>{const{to:t}=e;return t.startsWith("http")?a.createElement(o,i({as:"a",href:t},e)):a.createElement(o,e)},c=a.memo(s)},1264:(e,t,n)=>{n.d(t,{Z:()=>r});var a=n(7294);const r=()=>a.createElement("img",{alt:"ReDota",src:"./images/logo.svg"})},2096:(e,t,n)=>{n.d(t,{Z:()=>i});var a=n(7294),r=n(9163);const l=r.ZP.p`
  ...
  ${e=>"warning"===e.kind&&r.iv`
    color: #B08C00;
  `}
`,i=e=>{const{children:t,kind:n="notice"}=e;return a.createElement(l,{kind:n},t)}},3841:(e,t,n)=>{n.d(t,{tc:()=>m,mZ:()=>d,Ji:()=>u,Y:()=>p,$i:()=>g});var a=n(7294);const r="https://cdn.cloudflare.steamstatic.com/apps/dota2/images",l=e=>`${r}/dota_react/abilities/${e}.png`,i=(e,t)=>{let n="full.png";switch(t){case"portrait":n="vert.jpg";break;case"landscape":n="sb.png";break;case"icon":n="icon.png";break;default:n="full.png"}const a=e.replace("npc_dota_hero_","");return`${r}/heroes/${a}_${n}`},o=e=>{let t=e.replace("item_","");return t.startsWith("recipe_")&&(t="recipe"),`${r}/items/${t}_lg.png`},s=e=>`${r}/team_logos/${e}.png`,c=e=>{const{alt:t,src:n}=e;return a.createElement("img",{src:n,draggable:"false",alt:t,style:{userSelect:"none"}})},m=a.memo((e=>{const{refname:t}=e;return a.createElement(c,{src:l(t)})})),d=a.memo((e=>{const{refname:t,variant:n}=e;return a.createElement(c,{src:i(t,n)})})),u=a.memo((e=>{const{refname:t}=e;return a.createElement(c,{src:o(t)})})),p=a.memo((e=>{const{alt:t,teamID:n}=e;return a.createElement(c,{alt:t,src:s(n)})})),h=a.memo((e=>{const{refname:t,variant:n}=e,r=((e,t)=>{switch(t){case"portrait":return`./images/portraits/${e}.jpg`;case"icon":return`./images/icons/${e}.png`;default:return null}})(t,n);return r?a.createElement(c,{src:r}):null})),g=a.memo((e=>{const{unit:t,unit:{refname:n},variant:r}=e;return"hero"===t.type?a.createElement(d,{refname:n,variant:r}):a.createElement(h,{refname:n,variant:r})}))},9649:(e,t,n)=>{n.d(t,{g:()=>l,U:()=>r});var a=n(9163);const r=a.ZP.div.withConfig({shouldForwardProp:e=>"wrap"!==e})`
  display: flex;
  flex-direction: row;
