...
`,I=e=>{const{children:t}=e;return(0,c.K)(),r.createElement($,null,r.createElement(F,null,r.createElement(C,null),r.createElement(T,null),r.createElement(A,null)),t)},O=(0,i.ZP)(b)`
  text-align: center;
...
`,b=e=>{const{team:t,isWinner:a}=e,{name:n,players:l,proID:i}=t;return r.createElement(E,null,a&&r.createElement(s.Z,{name:"trophy",title:"Winner"}),i>0&&r.createElement(m.Z,{alt:n,teamID:i}),r.createElement(h.U,null,l.map((e=>r.createElement(p.mZ,{key:e.hero,refname:e.hero,variant:"landscape"})))))},v=(0,n.ZP)(h.g)`
